...
class DataManager:
    ...
    def get_page_count(self):
        """
        This function count how many pages run Zillow.
        :return: count_page
        """
    ...
    def get_data(self, number_of_pages):
        """
        This function parse total data from all pages that Zillow run.
        :param number_of_pages: Number of pages <= number, which get_page_count function return.
        :return: None
        """
    ...
    def get_house_links(self):
        """
        This function extract all links from total data.
        :return: None
        """
    ...
    def get_addresses(self):
        """
        This function extract all addresses from total data.
        :return: None
        """
        for data_block in self.data:
    ...
    def get_prices(self):
        """
        This function extract all prices from total data.
        :return: None
        """
